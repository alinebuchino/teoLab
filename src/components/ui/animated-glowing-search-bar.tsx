      ...
      <div id="poda" className="relative flex items-center justify-center group">
        ...
        <div id="main" className="relative group">
          <input 
            ...
            type="text" 
            name="text" 
            className="bg-background border border-border/20 w-[301px] h-[56px] rounded-lg text-foreground px-[59px] text-lg focus:outline-none placeholder-muted-foreground focus:border-accent/50 transition-colors" 
          />
          <div id="input-mask" className="pointer-events-none w-[100px] h-[20px] absolute bg-gradient-to-r from-transparent to-background top-[18px] left-[70px] group-focus-within:hidden"></div>
          <div id="pink-mask" className="pointer-events-none w-[30px] h-[20px] absolute bg-accent top-[10px] left-[5px] blur-2xl opacity-80 transition-all duration-2000 group-hover:opacity-0"></div>
          ...
          <div id="filter-icon" className="absolute top-2 right-2 flex items-center justify-center z-[2] max-h-10 max-w-[38px] h-full w-full [isolation:isolate] overflow-hidden rounded-lg bg-gradient-to-b from-muted via-background to-muted border border-border/30">
