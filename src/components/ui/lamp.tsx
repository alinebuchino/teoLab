...
export const LampContainer = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex w-full flex-1 scale-y-150 items-start justify-center isolate z-0 pt-20">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[50rem] bg-gradient-conic from-accent via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[50rem] bg-gradient-conic from-transparent via-transparent to-accent text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-accent-glow blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "20rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[40rem] -translate-y-[7rem] bg-accent-glow opacity-0"
        ></motion.div>
