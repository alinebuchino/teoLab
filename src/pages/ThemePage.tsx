  ...
  const articlesByTheme: Record<string, any[]> = {
    "doutrina-da-salvacao": [
      ...
      },
      {
        ...
        excerpt: "A doutrina central que transformou a compreensão da salvação na história da igreja.",
        category: "Soteriologia",
      ...
      },
      {
        ...
        excerpt: "Compreendendo o papel do Espírito Santo na transformação contínua do crente.",
        category: "Soteriologia",
    ...
    "cristologia": [
      ...
      },
      {
        ...
        excerpt: "Entendendo a união hipostática: Jesus como verdadeiro Deus e verdadeiro homem.",
        category: "Cristologia",
      ...
      },
      {
        ...
        excerpt: "O significado e alcance da morte e ressurreição de Jesus para a redenção humana.",
        category: "Cristologia",
    ...
    "escatologia": [
      {
        ...
        excerpt: "Comparando as principais interpretações sobre o reino milenar de Cristo.",
      ...
      },
      {
        ...
        excerpt: "O que as Escrituras revelam sobre o retorno triunfante do Messias.",
        category: "Escatologia",
      ...
      },
      {
        ...
        excerpt: "Compreendendo o destino eterno e o estado entre a morte e a ressurreição.",
        category: "Escatologia",
    ...
    "estudos-biblicos": [
      ...
      },
      {
        ...
        excerpt: "Entendendo o mundo antigo para compreender melhor as Escrituras.",
        category: "Hermenêutica",
      ...
      },
      {
        ...
        excerpt: "Como reconhecer e interpretar diferentes tipos de literatura bíblica.",
        category: "Hermenêutica",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {articles.map((article, index) => (
                ...
                >
                  ...
                  <Button variant="ghost" size="sm" className="mt-4 w-full group-hover:text-accent">
                    Ler Artigo
                  </Button>
                </article>
              ))}
